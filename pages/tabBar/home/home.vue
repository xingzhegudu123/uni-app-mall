	...
	<view>
		...
		<view class="swiper">
			<view class="swiper-box">
				<swiper class="swiper" circular="true" autoplay="true"   @change="swiperChange" :interval="interval" :duration="duration">
                        <swiper-item  v-for="swiper in swiperList" :key="swiper.id">
                            <image :src="swiper.img">A</image>
                        </swiper-item>
                 </swiper>
				 <view class="indicator">
					 <view class="dots" :class="{'on': currentSwiper>=index}" v-for="(swiper, index) in swiperList" :key="index"></view>
				 </view>
			</view>
		</view>
		<!-- 分类列表 -->
